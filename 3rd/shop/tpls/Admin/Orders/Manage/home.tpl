...
<field title="Montant de la commande" type="order_value" value="<?=$order['order_value']?>" />
<field title="Date de la commande" type="time" name="order_end" value="<?=$order['order_end']?>"/>

<field title="Status de la commande">
<select name="order_status">
    <?=dsp::dd("order_status",$order['order_status'])?>
</select>
</field>
...
<field type="text" name="order_comment" style="height:150px">
    <?=XML_EMPTY.$order['order_comment']?>
</field>
</fields>
<p><span>Client</span><var><a target='user_manage' href='/?/Admin/Users//<?=$distributor_id?>/Manage'><?=$distributor_infos['user_name']?></a></var></p>
<p><span>&order_start;</span><var><?=$order['order_start']?></var></p>
<p><span>&order_end;</span><var><?=$order['order_end']?></var></p>
