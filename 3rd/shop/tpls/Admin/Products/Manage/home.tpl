...
<em>Les champs vides seront enregistrés NULL</em>
    ...
    <field type="product_ref" title="Ref du produit" value="<?=$product_infos['product_ref']?>"/>
    <field type="product_descr" title="Description" style="height:130px"><?=specialchars_encode($product_infos['product_descr'])?></field>
    <field type="product_descr_long" title="Description(suite)" style="height:130px"><?=specialchars_encode($product_infos['product_descr_long'])?></field>
