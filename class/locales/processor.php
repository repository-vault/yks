...
/*
    ...
    given a text ($str) in a language ($lang) locales_processor::process_entities($str, $lang)
    will translate every registered entity pattern into their value (depending on $lang)
    to register an entity decoder, please use locales_processor::register($entity_prefix, $callback function)
    the registered callback will receive : $entity_type, $entities_vals, $lang at call
*/

class locales_processor {
  ...
  public static function register_mykse_renderer($myks_type, $birth_key=false, $birth_name=false){
