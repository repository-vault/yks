...
class procedure {
  ...
  function check(){
    ...
    $args=join(', ',$args);
    $out=type_resolve_out($this->xml_def['type']);
  ...
  **/
  ...
  function sql_infos(){
    ...
    $this->sql_def=array(
        ...
        'def'=>trim(newline($data['routine_definition'])),
    );
  ...
  function xml_infos(){
    $data=array(
        ...
        'def'=>newline(trim(specialchars_decode((string)$this->proc_xml->def))),
    );
